...
function moreContent ( ) {
	var addBacon = document.getElementById ('main');
	addBacon.id = 'more';
...
function showPrice ( ) {
	var pElem = document.getElementById ('oreo');
...
random.addEventListener ('click', quoteGen);


function quoteGen ( ) {
	var arr = quotes[Math.floor(Math.random()*quotes.length)];
	var pElem = document.getElementById ('random');
	pElem.innerHTML = arr;
